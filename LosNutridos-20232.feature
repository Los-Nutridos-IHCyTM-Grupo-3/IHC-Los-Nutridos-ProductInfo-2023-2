...
Feature: US18: Visualizar producto en Realidad Extendida

    Como usuario 
    quiero visualizar un modelo realista del producto dentro del catálogo de la aplicación
    para conocer su tamaño y forma. 

    Scenario: Dirigirse al catálogo
    Dado que el <usuario> se encuentra logueado en la <aplicacion>
    Cuando el <usuario> presione el botón de <Catalogo de productos>
    Entonces el <usuario> será redirigido a la <pestanha de catalogo de productos>
    Y el <usuario> podrá verificar la <informacion de los productos>
    ...
    Scenario: Visualizar el producto en 3D con dispositivo compatible
    Dado que el <usuario> se encuentra en la pestaña de <Catalogo de productos>
    Cuando el <usuario> seleccione un <producto>
    Y presione el botón <Visualizar el producto en 3D>
    Y la <aplicacion> verifique que su <dispositivo> presenta compatibilidad con <sistemas de tecnologia AR>
    Entonces la <aplicacion> utilizará la <camara del dispositivo> para presentar un <modelo 3D del producto>
    ...
    Scenario: Visualizar el producto en 3D con dispositivo no compatible
    Dado que el <usuario> se encuentra en la pestaña de <Catalogo de productos>
    Cuando el <usuario> seleccione un <producto>
    Y presione el botón <Visualizar el producto en 3D>
    Y la <aplicacion> verifique que su <dispositivo> presenta no compatibilidad con <sistemas de tecnologia AR>
    Entonces la <aplicacion> mostrará el <mensaje> <Dispositivo no compatible con la caracteristica>
